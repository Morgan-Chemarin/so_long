...
SRCS = main.c src/map_parser.c src/free_and_close.c src/render.c src/utils.c src/controls.c get-next-line/get_next_line.c get-next-line/get_next_line_utils.c
OBJS = $(SRCS:.c=.o)
